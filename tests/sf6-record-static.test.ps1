...
Assert-Fixed $html "judgeAntenKinds" 'street judge antenna chips are missing'
Assert-Fixed $html "recordJudgeFromSheet" 'street judge recorder is missing'
Assert-Fixed $html "selectedJudgeAnten" 'street judge antenna draft is missing'
...
Assert-Fixed $html "hintKey:'judge'" 'street judge sheet hint key is missing'
