...
Assert-Fixed $html "judgeAddG" 'street judge add input is missing'
Assert-Fixed $html "recordJudgeFromSheet" 'street judge recorder is missing'
Assert-Fixed $html "judgeAddDraft" 'street judge add draft is missing'
...
Assert-Contains $html "previousScrollTop" 'sheet scroll preservation marker is missing'
Assert-Contains $html "body\.scrollTop=previousScrollTop" 'sheet scroll position should be restored after redraw'
