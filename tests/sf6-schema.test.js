...
function testIdempotentVersion8() {
  const input = {
    machine: 'L-SF6',
    ver: '8',
    sourceVer: '6',
...
function testVersion7UpgradesTo8() {
  const normalized = normalizeSf6Export({
    machine: 'L-SF6',
    ver: '7',
    battleState: 'battle',
...
function testVersion8StageAndAutoColor() {
  const normalized = normalizeSf6Export({
    machine: 'L-SF6',
    ver: '8',
    currentStage: 'ルーク',
