...
時給の前提は通常時250回転/hの仮定です。導入日の実測では、22回転の台で約350回転/hでした。回転率が低い台ほど保留が切れて時速は落ちますが、それでも300回転/h前後は出ると見ています。回転率16〜17の台で実測が取れ次第、この前提を更新します。時速が上がると、打ち始めのラインは上の表より10回転ほど浅くなります。
