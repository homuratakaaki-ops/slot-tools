(function(){
  ...
  const ED=[
    ['e1','ED中の手形','レア役成立で出現・設定示唆と推測（詳細調査中）',1]
  ];
  const COINS=[
    ['cu','ユニバプレート 銅','設定2以上濃厚（推測値）',1],
    ['ag','ユニバプレート 銀','設定3以上濃厚（推測値）',1],
    ['au','ユニバプレート 金','設定4以上濃厚（推測値）',1],
    ['dg','ユニバプレート 花火柄','設定5以上濃厚（推測値）',1],
    ['rb','ユニバプレート 虹','設定6濃厚（推測値）',1]
  ];
  ...
  <section class="sec"><div class="sec-h">ユニバプレート</div>
    ...
    <div class="hint">⚠ 示唆内容は推測値。ホール側カスタム機能で出現バランスが変化するため過信は禁物（出典参照）。</div></section>
