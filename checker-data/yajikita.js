(function(){
  ...
  <section class="sec">
    ...
    <div class="hint">温泉前兆の分母は数え方に注意です。CZを経由しないAT直撃と、まいるチャージ終了後の温泉前兆移行を記録します。温泉前兆の分母は、まいるチャージが規定まいるに到達せずに終了した回数だけを数えます（到達して関所チャレンジに進んだ場合は数えません）。出典の設定判別項には「まいるチャージ4回以上」という条件の記載もあるため、%は参考値として扱ってください。AT直撃は1日ではほとんど発生しないため、引けた場合の材料として扱ってください。</div>
  </section>`;
  }
