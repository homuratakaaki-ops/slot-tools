(function(){
  ...
  <section class="sec">
    ...
    <div class="hint">2人目と5人目でシナリオが分かります。2人目（百合川ハナ=①③／四谷恭介=②④）と5人目（神社の怪=①②／山の神様=③④）の組み合わせでシナリオを特定できます。</div>
  </section>
  <section class="sec">
    <div class="sec-h">参照<span class="sub">記録対象外</span></div>
    <div class="hint">次の項目は記録対象外です。エンディング中の1枚絵は終了画面と同じ設定示唆パターンが出現します（到達自体が稀なため記録欄は設けていません）。弱レア役のCZ当選率・レア役契機のCZ高確移行率にも設定差がありますが、通常中とCZ高確中で数値が大きく異なり、高確状態を遊技中に確定できないため本ツールでは記録対象外としています。詳細はちょんぼりすた様の解析ページをご覧ください。</div>
  </section>`;
  }
