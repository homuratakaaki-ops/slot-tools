(function(){
  ...
  <section class="sec">
    ...
    <div class="hint">合算はカードで自動計算されます。BB合算・RB合算・総合算はカードで自動計算（合算目安 BB:1/273.1⇔1/229.1／RB:1/409.6⇔1/229.1／総:1/163.8⇔1/114.6）。中段チェリー・単チェリーはボーナス濃厚（成立時は契機に応じ上記4種でカウント）</div>
  </section>`;
  }
